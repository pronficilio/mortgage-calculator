...
function setInputFilter(textbox) {
  ...
  textbox.addEventListener("keyup", function (e) {
    ...
    var ret = keyCode >= 48 && keyCode <= 57; /// if keycode is a number
...
function calculate() {
  ...
  var yearsOfMortgage = document.querySelector(".slider--years--value").value; // get input text values
  ...
  var annualInsurance = document.querySelector(".input__text--insurance").value.replace(/,/g, ''); // Simple validation
  ...
  document.querySelector(".output--result--total").classList.add("calculated"); // add class to show in mobile version
...
setSliderListeners(sliders); // set the filter for numbers in input text
